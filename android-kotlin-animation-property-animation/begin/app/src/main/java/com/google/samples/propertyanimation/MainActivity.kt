...
class MainActivity : AppCompatActivity() {
    ...
    private fun scaler() {
        // содержат только информацию о свойствах и значениях для анимации а не то что нужно анимировать(View)
    ...
    private fun shower() {
        // Получаем FrameLayout
        val container = star.parent as ViewGroup
        // Получаем ширину и высоту FrameLayout
