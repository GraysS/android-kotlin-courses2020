...
//Элемент, Transition который MotionScene указывает продолжительность анимации, триггер и способ перемещения видов.
//Объект, ConstraintSet который определяет начальные и конечные ограничения перехода.
